...
4. КЭШБЭК 10%: через 3 сообщения упоминай эксклюзивный кэшбэк 10% от ОсОО "Арай групп"!
...
И не забудьте — у нас кэшбэк 10% от ОсОО «Арай групп»! 💰
...
Напишите ОФОРМИТЬ или задайте вопрос 🛡️"""
        ...
        'ky': {
            'price': f"""Такыба ОСАГО үчүн мен төмөнкүлөрдү билишим керек:
...
Мен «Арай групп» ЖООнун ассистентимин, «Бакай Иншуренстин» расмий агенти.
...
ТАПШЫРМА жазыңыз же суроо бериңиз 🛡️"""
        },
...
Write APPLY or ask a question 🛡️"""
        },
